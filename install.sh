...
prosupported=" CentOS/RHEL/Scientific Linux 7 on x86_64
 CentOS and RHEL 6 and 7 on i386 and x86_64
...
unmaintained. If you had troubles with the new install.sh, this is not
the solution to those troubles.

Ask about your troubles with the new install.sh in the forums and we'll
be able to help.
...
install_virtualmin_release () {
	...
	case $os_type in
		...
		debian | ubuntu)
			...
			sed -ie "/backports/b; s/#*[ ]*deb \(.*\) universe$/deb \1 universe/" /etc/apt/sources.list
